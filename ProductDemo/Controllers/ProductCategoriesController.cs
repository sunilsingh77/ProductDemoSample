...
namespace ProductDemo.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ProductCategoriesController(ProductDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductCategories != null ? 
                          ...
                          Problem("Entity set 'ProductDbContext.ProductCategories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProductDbContext.ProductCategories'  is null.");
            }
            var productCategory = await _context.ProductCategories.FindAsync(id);
            if (productCategory != null)
            {
